...
class RunningView: UIViewController {
	...
	override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: RunningCell.identifier, bundle: Bundle.main), forCellReuseIdentifier: RunningCell.identifier)
		loadData()
	...
	func setChartUI() {
		...
		xAxis.valueFormatter = RunningDateValueFormatter()
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RunningView: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: RunningCell.identifier, for: indexPath) as! RunningCell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RunningView: UITableViewDelegate {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RunningView: ChartViewDelegate {

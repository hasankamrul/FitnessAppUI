...
class CreateTrainingView: UIViewController {
    ...
    func initView() {
        ...
        collectionView.register(UINib(nibName: CreateTrainingCell1.identifier, bundle: Bundle.main), forCellWithReuseIdentifier: CreateTrainingCell1.identifier)
        collectionView.register(UINib(nibName: CreateTrainingCell2.identifier, bundle: Bundle.main), forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: CreateTrainingCell2.identifier)
    }
...
extension CreateTrainingView: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
		...
		if (kind == UICollectionView.elementKindSectionHeader) {
            guard let reusableView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: CreateTrainingCell2.identifier, for: indexPath) as? CreateTrainingCell2 else {return UICollectionReusableView()}
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CreateTrainingCell1.identifier, for: indexPath) as! CreateTrainingCell1

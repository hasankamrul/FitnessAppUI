...
class CaloriesView: UIViewController {
    ...
    func initView() {
        ...
        tableView.register(UINib(nibName: CaloriesCell.identifier, bundle: Bundle.main), forCellReuseIdentifier: CaloriesCell.identifier)
...
extension CaloriesView: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: CaloriesCell.identifier, for: indexPath) as? CaloriesCell else {
